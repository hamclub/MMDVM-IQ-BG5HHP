...
public:
	...
	void setUARTConnection(const std::string& port, unsigned int speed, bool debug);
	void setUDPConnection(const std::string& modemAddress, uint16_t modemPort, const std::string& localAddress, uint16_t localPort, bool debug);
